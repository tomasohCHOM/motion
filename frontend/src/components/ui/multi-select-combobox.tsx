...
export function MultiSelectCombobox({
    ...
    return (
        <Command ref={commandRef} className="relative overflow-visible bg-transparent">
            <div
                className="group rounded-md border border-input px-2 py-1 text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
            >
